<template>
    <div class="continentesView">
        <div class="container">
            <fieldset>
                <legend>Registro de Continentes</legend>
...
export default {
    ...
    methods: {
        ...
        findByid: function (id) {
            ...
            axios.get('http://localhost:9000/api/continentes/' + id).then(result => {
        ...
        deleteById: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete('http://localhost:9000/api/continentes/' + id,).then(() => {
                        this.loadData();
                        this.clearList();
                    });
                }
        ...
        addData: function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('http://localhost:9000/api/continentes', data).then(result => {
                        if (result.data) {
                            this.loadData();
                            this.clearList();
                        }
        ...
        dataUpdate: function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('http://localhost:9000/api/continentes/' + this.id, data).then(result => {
                        if (result.data) {
                            this.loadData();
                            this.clearList();
                        }
